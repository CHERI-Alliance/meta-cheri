...
```shell
kas-container build kas/qemu-riscv64-cheri-minimal.yml
```
...
```shell
kas-container shell kas/qemu-riscv64-cheri-minimal.yml -c 'runqemu qemuriscv64cheri nographic slirp snapshot'
```
